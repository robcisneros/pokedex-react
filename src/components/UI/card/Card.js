            ...
            <div className={classes.oneRow} >
              <div className={classes.oneJustifyItem} >
                ...
                <div className={classes.screen} >
                  <img src="../../../assets/img/pokeball.png" alt="Pokemon" id="pokeImg" />
                </div>
              </div>
            </div>
          </div>
        ...
        <div className={`${classes.oneRow} ${classes.leftButtonsContainer}`}>
          ...
          <div className={classes.thirdColum} >
            <div className={classes.joystickRow} >
              <div></div>
              <div className={`${classes.joystickUnit} ${classes.borderc1}`}></div>
              <div></div>
            </div>
            <div className={classes.joystickRow} >
              <div className={`${classes.joystickUnit} ${classes.borderc2}`}></div>
              <div className={classes.joystickUnit} ></div>
              <div className={`${classes.joystickUnit} ${classes.borderc3}`}></div>
            </div>
            <div className={classes.joystickRow}>
              <div></div>
              <div className={`${classes.joystickUnit} ${classes.borderc4}`}></div>
              <div></div>
            </div>
          </div>
        </div>
      ...
      <div className={`${classes.rightPokedex} ${classes.mainRed}`}>
        ...
        <div className={classes.rightButtonsContainer} >
          ...
          <div className={classes.circleRayasContainer} >
            ...
            <div className={`${classes.smallCircle} ${classes.justrightcir}`}></div>
          </div>
        </div>
